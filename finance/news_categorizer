...
topic = st.text_input("Enter a news topic (e.g., AI, climate, finance):", "Artificial Intelligence")
        ...
        if articles:
            for idx, article in enumerate(articles, 1):
                ...
                with st.spinner("Summarizing and categorizing..."):
                    summary, category = summarize_and_categorize(article.get('content', '') or article.get('description', ''), OPENAI_API_KEY)
